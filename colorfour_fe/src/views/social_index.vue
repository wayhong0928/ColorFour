...
<script>
  ...
  export default {
        ...
        posts: [
          ...
          },
          {
            ...
            commentList: [
              ...
              {
                username: "用戶B",
                content: "哇，藝術家！這幅畫的細節太美了，厲害！",
                avatar: "https://picsum.photos/25?random=7",
              },
              { username: "用戶C", content: "喜歡你的風格，這次的作品也很棒！💖", avatar: "https://picsum.photos/25?random=8" },
              {
                username: "用戶D",
                content: "感覺好有故事的一幅畫，真想多了解背後的靈感～",
                avatar: "https://picsum.photos/25?random=9",
              },
              {
                username: "用戶E",
                content: "每次看到你的作品都讓人眼前一亮，繼續加油！💪",
                avatar: "https://picsum.photos/25?random=10",
              },
              {
                username: "用戶F",
                content: "這畫充滿了獨特的情感，能感受到你的用心！👍",
                avatar: "https://picsum.photos/25?random=11",
              },
              {
                username: "用戶G",
                content: "每次看到你的作品，都覺得很震撼！這幅畫真的很有層次感～👏",
                avatar: "https://picsum.photos/25?random=12",
              },
            ],
            isFollowing: false, // 初始狀態為未追蹤
          },
    ...
    methods: {
      ...
      // 跳轉到編輯頁面
      editPost(postId) {
        this.$router.push({ name: "social_edit", params: { postId } }); // Pass postId as a parameter} });
      },
      deletePost(post) {
      ...
      async handleGoogleLoginAndSubmitComment(response, post) {
        try {
          ...
          const commentResponse = await axios.post(
            "http://localhost:8000/social_platform/comments/",
            {
